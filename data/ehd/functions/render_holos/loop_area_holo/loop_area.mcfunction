...
execute as @e[type=marker,tag=holo_looper,tag=x_looper,limit=1] at @s run tp @s ^ ^ ^-0.08
...
execute if score .sizeX ehd_pos matches 1.. rotated -90 0 run function ehd:render_holos/loop_area_holo/ray_x
execute if score .sizeX ehd_pos matches ..0 rotated 90 0 run function ehd:render_holos/loop_area_holo/ray_x
